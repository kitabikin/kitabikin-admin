...
export class StoreThemeDetailGuard implements CanActivate {
  // Variable
  id!: string;
  ...
  private get state$(): Observable<ThemeData | undefined> {
    return this.store.select(selectTheme(this.id));
  }
