...
export class StoreRoleDetailGuard implements CanActivate {
  // Variable
  id!: string;
  ...
  private get state$(): Observable<RoleData | undefined> {
    return this.store.select(selectRole(this.id));
  }
